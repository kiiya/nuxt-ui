...
import require$$0, { reactive, getCurrentInstance, ref, computed, defineComponent, resolveComponent, withCtx, createVNode, resolveDynamicComponent, openBlock, createBlock, useSSRContext, h, Transition, Suspense, createCommentVNode, shallowRef, createApp, mergeProps } from "vue";
import { ssrRenderComponent, ssrRenderVNode, ssrRenderSuspense, ssrRenderAttrs, ssrRenderList, ssrInterpolate } from "vue/server-renderer";
import { GlobeAltIcon, ScaleIcon, LightningBoltIcon, AnnotationIcon } from "@heroicons/vue/outline";
...
const vueuseHead_1356d911 = defineNuxtPlugin((nuxtApp) => {
...
const plugin_614a59f6 = defineNuxtPlugin((nuxtApp) => {
...
const NuxtNestedPage = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$5]]);
const layouts = {};
...
const router_912d1e8c = defineNuxtPlugin((nuxtApp) => {
...
const features$1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1]]);
