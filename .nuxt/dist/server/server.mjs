...
__vite_ssr_exports__.default = [
  {
    "name": "error",
    "path": "/error",
    "file": "/home/kiiya/Code/ui-playground/pages/error.vue",
    "children": [],
  ...
  },
  {
    "name": "success",
    "path": "/success",
    "file": "/home/kiiya/Code/ui-playground/pages/success.vue",
    "children": [],
    "component": () => __vite_ssr_dynamic_import__('/pages/success.vue')
  }
];
}
...
// - /@id/plugin-vue:export-helper ($id_bbb863c1)
// --------------------
const $id_3663620c = async function (global, __vite_ssr_exports__, __vite_ssr_import_meta__, __vite_ssr_import__, __vite_ssr_dynamic_import__, __vite_ssr_exportAll__) {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${__vite_ssr_import_1__.ssrRenderAttrs(__vite_ssr_import_0__.mergeProps({ class: "min-h-screen mx-auto items-center justify-center flex flex-col p-5 bg-gray-100" }, _attrs))}><!-- <img src="https://i.pinimg.com/originals/35/f3/23/35f323bc5b41dc4269001529e3ff1278.gif" class="rounded-md" alt="" /> --><div class="shadow-2xl p-10 w-full rounded-2xl space-y-4 flex items-center justify-center bg-white flex-col"><div class="w-32 h-32 flex items-center rounded-full justify-center"><svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24 text-red-500 stroke-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg></div><div class="mt-4 text-xl">Whoopsie!</div><p class="text-center text-lg text-gray-600">There was an error processing your payment.</p><button class="bg-green-500 w-full py-2 text-white font-semibold rounded-md">Explore Discounts</button></div></div>`)
}
...
__vite_ssr_exports__.default = /*#__PURE__*/__vite_ssr_import_3__.default(_sfc_main, [['ssrRender',_sfc_ssrRender],['__file',"/home/kiiya/Code/ui-playground/pages/error.vue"]]);
}
...
// - /@id/plugin-vue:export-helper ($id_bbb863c1)
// --------------------
const $id_5228deeb = async function (global, __vite_ssr_exports__, __vite_ssr_import_meta__, __vite_ssr_import__, __vite_ssr_dynamic_import__, __vite_ssr_exportAll__) {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${__vite_ssr_import_1__.ssrRenderAttrs(__vite_ssr_import_0__.mergeProps({ class: "min-h-screen mx-auto items-center justify-center flex flex-col p-5 bg-gray-100" }, _attrs))}><!-- <img src="https://i.pinimg.com/originals/35/f3/23/35f323bc5b41dc4269001529e3ff1278.gif" class="rounded-md" alt="" /> --><div class="shadow-2xl p-10 w-full rounded-2xl space-y-4 flex items-center justify-center bg-white flex-col"><div class="w-32 h-32 flex items-center rounded-full justify-center"><svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24 text-green-500 stroke-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg></div><div class="mt-4 text-xl">Success!</div><p class="text-center text-lg text-gray-600">Congraturations! Your payment was complete.</p><button class="bg-green-500 w-full py-2 text-white font-semibold rounded-md">Explore Discounts</button></div></div>`)
}
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = __vite_ssr_import_2__.useSSRContext()
  ;(ssrContext.modules || (ssrContext.modules = new Set())).add("pages/success.vue")
  return _sfc_setup ? _sfc_setup(props, ctx) : undefined
}
const __vite_ssr_import_3__ = await __vite_ssr_import__("/@id/plugin-vue:export-helper");

__vite_ssr_exports__.default = /*#__PURE__*/__vite_ssr_import_3__.default(_sfc_main, [['ssrRender',_sfc_ssrRender],['__file',"/home/kiiya/Code/ui-playground/pages/success.vue"]]);
}
